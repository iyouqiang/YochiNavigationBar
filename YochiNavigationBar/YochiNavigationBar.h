...
#pragma mark - UIColor
@interface UIColor (YochiAddition)
...
@interface UINavigationBar (YochiAddition) <UINavigationBarDelegate>
...
@interface UIViewController (YochiAddition)
