#
#  Be sure to run `pod spec lint YochiNavigationBar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC 
YochiNavigationBar是一个快速适配导航栏的工具
                   DESC
  ...
  s.source       = { :git => "https://github.com/iyouqiang/YochiNavigationBar.git", :tag => "1.0.0" }
